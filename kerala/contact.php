...
<?php
 include_once('travel_connection.php');
...
if(isset($_POST['submit']))
{
 ...
 $email  =  $_POST['email'];
 $msg;
 if(mysql_query("insert into contact_table (name,phnum,email) values(' $name','$phnum','$email')"))
 {

        $msg ="Our Team will contact back You soon :) !!";	 
...
<meta charset="utf-8">
  ...
  <style>
  .contact
{ height:400px; width:400px; border:1px; border-top-style:dotted; border-bottom-style:dotted; border-radius:20px; margin:auto; margin-top:20px;}
.t
{ font-size:18px; margin-top:20px; margin-left:10px}
.t1
{ height:40px; width:340px; margin-left:20px; }
.t2
{height:30px; width:400px; background-color:#FF66CC; text-align:center; margin-top:12px; border:none; border-radius:15px}
.v1
{ color:#FF0000}
.v2
{ color:#CC3366}
...
<div class="container-fluid">
<div class="contact">
<center><p><h2 style="color:#FF66CC">Contact Us</h2></p></center>
<form method="post" action="">
<label class="t">Name:-</label>
<input  class="t1" type="text" name="name" />
<label class="t">Phone No.:-</label>
<input class="t1"  type="text" name="phnum"  />
<label class="t">Email:-</label>
<input class="t1"  type="text" name="email"  />
<input class="t2"  type="submit"  value="Submit" name="submit" />
