...
<body style="background-attachment: scroll; background-color:#FFCCFF">
...
<div class="heading"><center><h1><a href="about.php">About Us</a></h1></center></div><br />
<div class="outer">
<div class="d1"><a href="#"><img src="img12.jpg" /></a></div>
<div class="d2"><h3>Travel Care</h3><p>General queries and answers regarding the commonly asked questions can be posted here. For example, availability of taxi/cab, best time to visit, how to reach a destination, activities available and so forth can be asked here. Your queries will be answered by the accredited tour operators from Kerala.</p></div>
</div><br /><br />
